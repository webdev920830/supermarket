...
function Footer(){
    return(
        <footer class="text-center lg:text-left text-dark bg-gray-200 text-base">
            <div class="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
                <div class="mr-12 hidden lg:block text-base">
                <span>Get connected with us on social networks:</span>
                </div>
                <div class="flex justify-center">
                <a href="#!" class="mr-6 text-dark">
            ...
            <div class="mx-6 py-10 text-center md:text-left">
                <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 lg:gap-32 gap-8">
                <div class="">
                    <h6 class="
                        uppercase
                        font-semibold
                ...
                <div class="">
                    ...
                    <p class="mb-4">
                        <Link to="/buy" class="text-dark">Buy</Link>
                    </p>
                    <p class="mb-4">
                        <Link to="/rent" class="text-dark">Rent</Link>
                    </p>
                    <p class="mb-4">
                        <Link to="/aboutus" class="text-dark">About Us</Link>
                    </p>
                    <p>
